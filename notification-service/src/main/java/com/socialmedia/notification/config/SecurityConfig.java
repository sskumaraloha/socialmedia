...
/**
 * A pure resource server - notification-service never issues tokens, only validates the
 * ones auth-service already issued (see common-library's JwtAuthenticationFilter/JwtValidator).
 */
@Configuration
@EnableWebSecurity
